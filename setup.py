...
MODULE = 'purchase_line_free_of_charge'
PREFIX = 'nantic'
MODULE2PREFIX = {}
OWNER = {
    'nantic':'NaN-tic',
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-purchase_line_free_of_charge',
    download_url='https://github.com:nantic/trytond-purchase_line_free_of_charge.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-purchase_line_free_of_charge.git'
    },
    classifiers=[
